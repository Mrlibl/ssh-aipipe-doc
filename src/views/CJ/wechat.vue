<template>
<div class="doc-page">
  <h1>chatgpt-on-wechat 配置教程</h1>

  <h2>OpenAI API 核心配置</h2>
  <p>打开配置文件，找到以下两项并按下方内容填写：</p>
  
  <div class="code-block">
    <pre><code># openai api配置
"open_ai_api_key": "sk-xxxxxx",  # openai api key
# openai apibase，当use_azure_chatgpt为true时，需要设置对应的api base
"open_ai_api_base": "https://api.aipipe.io/v1",</code></pre>
  </div>
...
available_setting = {
    ...
    "open_ai_api_key": "sk-xxxxxx",  # openai api key
    # openai apibase，当use_azure_chatgpt为true时，需要设置对应的api base
    "open_ai_api_base": "https://api.aipipe.io/v1",
    "proxy": "",  # openai使用的代理
...
# 全局配置，用于存放全局生效的状态
global_config = {"admin_users": []}</code></pre>
  </div>
</div>
</template>
